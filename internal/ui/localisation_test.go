...
func TestLocalisedScreensHelper(t *testing.T) {
	...
	t.Run("inline_prompt_surfaces", TestInlineMonitorPromptClicksAndSend)
	...
	t.Run("monitor_navigation_buttons", TestMonitorNavigationRenderedButtons)
	t.Run("approval_warning", TestMonitorApprovalWarningResponsiveClicks)
	t.Run("approval_reflow", TestMonitorApprovalButtonsReappearAfterDismissal)
