...
func TestLocalisedScreens(t *testing.T) {
	...
	for _, code := range []string{"en-GB", "nl", "de", "fr", "it", "es", "ru", "ja", "zh-Hans", "sv", "nb", "tr", "et", "fi", "pt-BR", "da"} {
...
func TestLocalisedScreensHelper(t *testing.T) {
	...
	t.Run("working_badge_and_detail", TestMonitorWorkingBadgeAndUntitledDetail)
